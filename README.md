...
- [X] (4 pts) **User can scroll through a list of 10 emails.**
  - Each email contains the following information:
    ...
    - Email title
    - Email summary
  - ![Image/GIF showing the basic email list display](https://i.imgur.com/7TohlwK.gif) <!-- Replace this link with your actual image/GIF link -->
...
Understanding how it works initially was difficult
## Resources
