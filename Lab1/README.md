...
Submitted by: Kristian Andrei Bulusan <!-- Replace 'Your Name Here' with your actual name -->
...
- [ ] **User can see a number displayed on the screen. The number starts at 0.**
    - ![Image/GIF showing the initial display of the number](https://i.imgur.com/NDcvIk9.gif) <!-- Replace this link with your actual image/GIF link -->

- [ ] **User can tap on a button to see the number displayed increase by 1.**
    - ![Image/GIF showing the number increase on button tap](https://i.imgur.com/NDcvIk9.gif) <!-- Replace this link with your actual image/GIF link -->
...
- [ X ] User can exchange number of taps accumulated for upgrades (e.g., each tap counts as 2 taps).
    - ![Image/GIF showing the upgrade process](https://i.imgur.com/NDcvIk9.gif) <!-- Replace this link with your actual image/GIF link -->
