    ...
    : RecyclerView.Adapter<BestSellerBooksRecyclerViewAdapter.BookViewHolder>()
{
    ...
    inner class BookViewHolder(val mView: View) : RecyclerView.ViewHolder(mView) {
        ...
        val mBookDescription:TextView = mView.findViewById(R.id.book_description) as TextView
        val mBookImage: ImageView = mView.findViewById(R.id.book_image) as ImageView
        val mBookButton: Button = mView.findViewById(R.id.buy_button) as Button
